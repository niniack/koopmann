...
###
test_components:
	uv run pytest -s tests/test_linear.py tests/test_conv.py tests/test_linear_block.py

test_models:
	uv run pytest -s tests/test_mlp.py tests/test_resmlp.py tests/test_autoencoder.py
...
test_block:
	uv run pytest -s tests/test_linear_block.py
