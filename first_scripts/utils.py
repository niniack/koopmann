...
def get_dataloaders(
    ...
    train_dataset = DatasetClass(config=config.train_data, root=config.train_data.root)
    ...
    test_dataset = DatasetClass(config=config.train_data, root=config.train_data.root)
