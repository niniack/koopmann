...
train_dataset = MNIST("/scratch/nsa325/", True, transform, download=True)
train_loader = DataLoader(dataset=train_dataset, batch_size=batch_size, shuffle=True)
test_dataset = MNIST("/scratch/nsa325", False, transform, download=True)
test_loader = DataLoader(dataset=test_dataset, batch_size=batch_size, shuffle=True)
# OoD dataset (Fashion MNIST), for NC5
ood_dataset = FashionMNIST("/scratch/nsa325", False, transform, download=True)
